...
import {
  ...
  Grid3X3, Dice5, UserCheck, CalendarDays, Layers, ShoppingCart, SlidersHorizontal,
} from 'lucide-react'
      ...
      <div className="flex items-center gap-1.5">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-48">
            ...
            <DropdownMenuItem onClick={() => navigate('/advanced-screener')}>
              <SlidersHorizontal className="mr-2 h-3.5 w-3.5" /> Pro Screener
            </DropdownMenuItem>
            <DropdownMenuSeparator />
